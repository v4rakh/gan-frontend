						...
						<Card.Body className="card-body">
							<Form name="form" onSubmit={handleSubmit}>
								<Form.Group>
									...
									/>
									{submitted && !address && (
										<div className="invalid-feedback">{t('page.subscription_verify.form.address_hint')}</div>
									)}
								</Form.Group>
								<Form.Group>
									...
									/>
									{submitted && !token && (
										<div className="invalid-feedback">{t('page.subscription_verify.form.token_hint')}</div>
									)}
								</Form.Group>
								<Form.Group>
									<div className="row">
